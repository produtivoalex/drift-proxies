...
int main(int argc, char *argv[])
{
    ...
    // Proxies are a pure cache: dropping one only costs the clip its smooth playback, so
    ...
    drift::ProxyCache::instance().load();
    drift::ProxyCache::instance().sweep(drift::ProxyCache::kDefaultMaxBytes);
