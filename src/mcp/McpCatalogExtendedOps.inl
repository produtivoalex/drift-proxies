        ...
        { "cancel_segmentation", "segmentation", "Stop segment job",
          ...
          objectSchema({}) },
        { "list_virtual_backgrounds", "segmentation", "List available virtual sets and background presets",
          "Returns {presets:[{id, name, category, badge, description, defaultBlur}]}. Use an id in apply_virtual_background.",
          objectSchema({}), true, false, true },
        { "apply_virtual_background", "segmentation", "1-click virtual set replacement behind person",
          "Replaces video background behind presenter with a virtual set (studio, podcast, neon, etc.). Automatically triggers neural cutout if needed, inserts background on track below, and applies cinematic depth of field blur.",
          objectSchema(mergeProps({{QStringLiteral("preset"), stringProp(QStringLiteral("Preset id from list_virtual_backgrounds (e.g. podcast-warm, studio-executive, studio-cyclorama-grey, dynamic-particles-gold)"))},
                                   {QStringLiteral("blur"), numberProp(QStringLiteral("Virtual depth of field blur amount (0.0 to 1.0)"))}},
                                  clipRefProps()),
                       {QStringLiteral("preset")}) },
        { "remove_virtual_background", "segmentation", "Remove virtual background track for a clip",
          "Removes virtual background clips linked beneath the target video clip.",
          objectSchema(clipRefProps()) },
